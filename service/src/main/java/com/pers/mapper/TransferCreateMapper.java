...
public class TransferCreateMapper implements Mapper<TransferCreateDto, Transfer> {
    ...
    public Transfer mapFrom(TransferCreateDto object) {
        return Transfer.builder()
                .cardNoFrom(cardRepository.findByCardNo(object.cardNoFrom()).orElseThrow(IllegalArgumentException::new))
                .cardNoTo(cardRepository.findByCardNo(object.cardNoTo()).orElseThrow(IllegalArgumentException::new))
